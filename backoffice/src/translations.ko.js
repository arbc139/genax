  ...
  result: {
    ...
    table: {
      methodType: {
        ...
        coOccurenceSingle: 'Co-occurence (Single node)',
      },
      download: {
        associationEdge: 'Association network edge',
        coOccurenceEdge: 'Co-occurence network edge',
        ...
        geneScoresByCoOccurence: 'Gene scores by co-occurence',
        geneScoresByCoOccurenceNode: 'Gene scores by co-occurence + node',
      },
    },
    instruction: {
      ...
      construction: {
        ...
        coOccurenceEdge: 'Number of Co-occurence Edges',
      ...
      analysis: {
        ...
        coOccurenceGene: 'Number of Genes (Co-occurence)',
        coOccurenceNodeTotal: 'Number of Genes (Co-occurence & Single Occurring Nodes)',
      },
    },
    reference: {
